export function StarIcon({ isFavorited }: { isFavorited: boolean }) {
  return (
    <svg
      ...
      } transition-color duration-400  absolute top-0`}
    >
      <path
        stroke='none'
        d='M0 0h24v24H0z'
...
export function StarIconFilled({ isFavorited }: { isFavorited: boolean }) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='20'
      ...
      fill='currentColor'
      className={`${
        isFavorited ? 'animate-pulseIn' : 'scale-0'
      } transition-transform duration-400 text-yellow-300 absolute top-0`}
    >
      <path
        stroke='none'
        d='M0 0h24v24H0z'
